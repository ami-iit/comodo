...
class RobotModel(KinDynComputations):
    ...
    def set_limbs_indexes(self, right_arm_indexes:list, left_arm_indexes:list, right_leg_indexes:list, left_leg_indexes: list, torso_indexes:list): 
    ...
    def get_idyntree_kyndyn(self):
        ...
        model_loader.loadReducedModelFromString(copy.deepcopy(self.urdf_string), self.joint_name_list)
    ...
    def compute_step_lenght(self,s,H_b): 
        ...
        relative_transf = self.w_H_torso(H_b,s)@np.linalg.inv(self.H_left_foot(H_b,s))
